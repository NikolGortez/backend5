...
$db_user = 'u53312';   // Логин БД
$db_pass = '7812270';  // Пароль БД
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    exit;}
?>
<body align="center" style="background-color: rgb(218, 196, 226);">
...
// Иначе, если запрос был методом POST, т.е. нужно сделать авторизацию с записью логина в сессию.
  ...
  $db = new PDO('mysql:host=localhost;dbname=u53312', $db_user, $db_pass, array(
